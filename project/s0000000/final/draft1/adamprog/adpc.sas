...
Program Name:      adpc.sas
Program Author:    Caroline Pearson (cpearson)
Program Purpose:   Create ADPC dummy records for 100 participants
...
run;
/*
proc contents data=adamdata.adpc;
run;

proc print data=adamdata.adpc(obs=12);
